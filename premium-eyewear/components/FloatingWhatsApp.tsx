...
export default function FloatingWhatsApp() {
  ...
  const myWhatsAppNumber = '919815532497';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center group">
      {/* Tooltip Pill */}
      <span className="hidden sm:inline-block mr-3 bg-slate-950/95 backdrop-blur-md text-white text-xs font-bold py-2 px-3.5 rounded-2xl shadow-xl border border-slate-800 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0 whitespace-nowrap pointer-events-none">
        💬 Chat on WhatsApp
      </span>
